...
class RkpassafterspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        url = 'http://www.rkpass.cn/tk_jiexi.jsp?product_id=201806131544056256919&tixing=anli&answer=&paper_id=580&tihao=2&cache=false'
    ...
    def parse_detail(self, response):
        ...
        answerAnalysis = "".join(answerAnalysis.split('软考在线[rkpass.cn]答案解析：'))
        print(answerAnalysis)
        # print(answerAnalysis.strip())
