...
class RkpassspiderSpider(scrapy.Spider):
    ...
    for i in range(23, 24):
        ...
        start_urls.append('http://www.rkpass.cn/tk_jiexi.jsp?product_id=201805311145373591757&tixing=xuanze&answer=&paper_id=&tihao=&cache=')
    ...
    def parse(self, response):
        ...
        answerAnalysis = response.xpath(".//table/tr[3]/td//text()").extract()[3].strip()  # 答案解析
